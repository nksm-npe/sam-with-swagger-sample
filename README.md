...
## sam deploy with swagger sample

```sh
aws s3 mb s3://cm-nksm-sam-test-bucket
aws s3 cp swagger.yaml s3://cm-nksm-sam-test-bucket/swagger.yaml
...
> WebAPI の Method が GET でも、x-amazon-apigateway-integration の httpMethod は POST を指定する
